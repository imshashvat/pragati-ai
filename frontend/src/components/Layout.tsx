...
// Dashboard shell — dark-navy sidebar + full MoSPI top navbar
// Mobile: sidebar collapses, hamburger button opens it as a slide-over drawer
...
const Icons = {
  ...
  Chart:    () => <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>,
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ padding: '18px 20px 16px', borderBottom: '1px solid rgba(255,255,255,0.07)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <div style={{ width: 32, height: 32, borderRadius: 8, background: 'linear-gradient(135deg,#0F62FE,#0050E6)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 14, fontWeight: 700, color: '#fff', boxShadow: '0 2px 8px rgba(15,98,254,.4)', flexShrink: 0 }}>P</div>
          <div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden', background: '#F7F8FA', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden', position: 'relative' }}>
        ...
        <main style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', display: 'flex', flexDirection: 'column' }}>
          <div style={{ maxWidth: 1400, margin: '0 auto', padding: '24px 16px 0', width: '100%', flex: 1 }}>
            <Outlet />
          </div>

          {/* Compact footer */}
          <footer style={{ marginTop: 40, padding: '16px 16px', borderTop: '1px solid #E8ECF0', background: '#fff' }}>
            <div style={{ maxWidth: 1400, margin: '0 auto', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 10 }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                <span style={{ fontSize: 12, fontWeight: 600, color: '#102A43' }}>PRAGATI-AI · PAIMANA Platform</span>
                <span style={{ fontSize: 11, color: '#8D8D8D' }}>Ministry of Statistics &amp; Programme Implementation · Government of India</span>
              </div>
              <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
                {[['About','/about'],['Sectors','/sectors'],['How It Works','/how-it-works'],['Contact Us','/contact']].map(([label, href]) => (
                  <a key={href} href={href} style={{ fontSize: 12, color: '#525252', textDecoration: 'none' }}
